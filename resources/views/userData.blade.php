...
<body>
    ...
    <div class="flex h-screen bg-gray-800 " :class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto bg-gradient-to-r from-red-800 via-orange-800 to-yellow-500 0">
            <header class="z-40 py-4  bg-gradient-to-r from-red-800 via-orange-800 to-yellow-500  ">
                <div class="flex items-center justify-between h-8 px-6 mx-auto">
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        ...
                        <li class="relative">
                            <button
                                class="p-2 bg-white text-orange-700 align-middle rounded-full hover:text-white hover:bg-green-400 focus:outline-none "
            ...
            <main class="px-4 sm:px-6 lg:px-8 py-10 space-y-6">
                <div class="grid gap-6 rounded-3xl bg-white border-4 border-orange-700 p-6 sm:p-8 lg:p-10">

                    <!-- Breadcrumb -->
                    <div class="flex items-center h-10">
                    <h2 class="text-sm sm:text-base md:text-lg font-semibold truncate opacity-80">
                        /Page/Data Overview
                    </h2>
                    </div>
                    ...
                    <!-- Heading -->
                    <div>
                    <h1 class="font-semibold text-2xl sm:text-3xl md:text-4xl">Data Overview</h1>
                    <p class="font-light mt-2 text-sm sm:text-base">Show off your data with another type of format!</p>
                    </div>

                    <!-- Filter Section Card -->
                    <div class="bg-gray-50 border rounded-2xl p-6 shadow-sm space-y-4 sm:space-y-0 sm:flex sm:flex-wrap sm:items-end sm:gap-4">
                    <div class="flex flex-col sm:w-auto w-full">
                        <label for="startTime" class="mb-2 font-medium">Mulai:</label>
                        <input type="datetime-local" id="startTime" class="border rounded px-3 py-2 w-full">
                    </div>
                    <div class="flex flex-col sm:w-auto w-full">
                        <label for="endTime" class="mb-2 font-medium">Sampai:</label>
                        <input type="datetime-local" id="endTime" class="border rounded px-3 py-2 w-full">
                    </div>
                    <div class="sm:w-auto w-full">
                        <button id="filterBtn" class="bg-orange-600 text-white px-4 py-2 rounded hover:bg-orange-700 transition w-full sm:w-auto">
                        Tampilkan
                        </button>
                    </div>
                    </div>
                    ...
                    <!-- Export Buttons Card -->
                    <div class="bg-gray-50 border rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row sm:justify-start gap-6">
                    <div class="flex flex-col gap-y-2">
                        <label class="font-medium">Export in table format</label>
                        <button id="exportExcelBtn" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition w-full sm:w-40">
                        Export Excel
                        </button>
                        <button id="exportPdfBtn" class="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition w-full sm:w-40">
                        Export PDF
                        </button>
                    </div>
                    <div class="flex flex-col gap-y-2">
                        <label class="font-medium">Export in chart format</label>
                        <button id="exportJpgBtn" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition w-full sm:w-40">
                        Export JPG
                        </button>
                    </div>
                    </div>
                    ...
                    <!-- Chart Card -->
                    <div class="bg-gray-50 border rounded-2xl p-6 shadow-sm overflow-auto">
                    <canvas id="gasChart" class="w-full max-w-full" style="height: 400px;"></canvas>
                    </div>
    ...
    <script type="module" src="/js/average.js"></script>
