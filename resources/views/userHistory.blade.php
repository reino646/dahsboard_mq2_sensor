    ...
    <div class="flex h-screen bg-gray-800 " :class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto bg-gradient-to-r from-red-800 via-orange-800 to-yellow-500">
            <header class="z-40 py-4  bg-gradient-to-r from-red-800 via-orange-800 to-yellow-500  ">
                <div class="flex items-center justify-between h-8 px-6 mx-auto">
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        ...
                        <li class="relative">
                            <button
                                class="p-2 bg-white text-orange-700 align-middle rounded-full hover:text-white hover:bg-orange-500 focus:outline-none "
            ...
            <main class="p-4">
                ...
                <p class="mt-2 font-light">Check the history of your sensor data!</p>
                </div>
