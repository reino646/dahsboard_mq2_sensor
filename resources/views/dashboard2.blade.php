...
<body>
                ...
                <div class="text-white">
                    ...
                    <div>
                        <ul class="mt-6 leading-10">
                            ...
                            <li class="relative px-2 py-1 pt-2">
                            <div class="mo-fire">
        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto bg-gradient-to-r from-red-800 via-orange-800 to-yellow-500 ">
            ...
            <main class="px-4 sm:px-6 lg:px-8 py-10">
                <div class="grid gap-6 rounded-3xl bg-white border-4 border-orange-700 p-6 sm:p-8 lg:p-10">
                    ...
                    <h2 class="text-sm sm:text-base md:text-lg font-semibold truncate opacity-80">/Page/Dashboard</h2>
                    </div>

                    <!-- Welcome Message -->
                    <div>
                    <h1 class="text-2xl sm:text-xl md:text-xl lg:text-4xl font-semibold truncate">
                        Welcome
                        <span class="bg-gradient-to-r from-red-500 via-orange-400 to-yellow-400 bg-clip-text text-transparent">
                        {{ session('displayName') }}!
                        </span>
                        <span class="wave ml-2">👋</span>
                    </h1>
                    <p class="font-light mt-2 text-sm sm:text-base">Look what's happening with your sensor's update</p>
                    </div>
                    ...
                    <h3 class="font-semibold text-base sm:text-lg mb-4">MQ2 Sensor Chart:</h3>
                    <div class="bg-stone-100 rounded-lg overflow-x-auto">
                        <canvas id="gasChart" class="w-full max-h-[400px] p-2 sm:p-4"></canvas>
                    </div>
                    </div>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    <script type="module" src="/js/chart-mq2.js"></script>
