...
<body>
    <div class="flex h-screen bg-gray-800 " :class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto bg-gradient-to-r from-red-800 via-orange-800 to-yellow-500">
            ...
            <main class="p-4">
                <div class="grid gap-6 mb-10 p-6 rounded-3xl bg-white border-4 border-orange-700">
                
                <!-- Header -->
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                <h2 class="text-lg font-semibold opacity-80 mb-2 sm:mb-0">/Page/Data History</h2>
                </div>
                <div>
                <h1 class="text-4xl font-semibold">Data History</h1>
                <p class="mt-2 font-light">Manage and check on the history of your sensor data!</p>
                </div>

                <!-- Filter Card -->
                <div class="bg-white shadow-md rounded-xl p-6">
                <h3 class="text-lg font-semibold mb-4">Filter Data Historis</h3>
                <div class="flex flex-col sm:flex-row sm:items-end gap-4">
                    <div class="flex flex-col">
                    <label for="startTime">Dari:</label>
                    <input type="datetime-local" id="startTime" class="border rounded-lg px-3 py-2 w-full sm:w-52" />
                    </div>
                    <div class="flex flex-col">
                    <label for="endTime">Sampai:</label>
                    <input type="datetime-local" id="endTime" class="border rounded-lg px-3 py-2 w-full sm:w-52" />
                    </div>
                    <button id="filterBtn" class="bg-orange-500 text-white px-4 py-2 rounded-lg hover:opacity-80 text-sm">Filter</button>
                </div>
                </div>

                <!-- Manage History -->
                <div class="bg-white shadow-md rounded-xl p-6">
                <h3 class="text-lg font-semibold mb-4">Kelola Riwayat</h3>
                <button id="clearAllBtn" class="bg-red-600 text-white px-4 py-2 rounded-lg hover:opacity-80 mb-4 text-sm">Clear All History</button>

                <div class="flex flex-col sm:flex-row sm:items-end gap-4">
                    <div class="flex flex-col">
                    <label for="deleteStartTime">Hapus Dari:</label>
                    <input type="datetime-local" id="deleteStartTime" class="border rounded-lg px-3 py-2 w-full sm:w-52" />
                    </div>
                    <div class="flex flex-col">
                    <label for="deleteEndTime">Sampai:</label>
                    <input type="datetime-local" id="deleteEndTime" class="border rounded-lg px-3 py-2 w-full sm:w-52" />
                    </div>
                    <button id="deleteByTimeBtn" class="bg-red-500 text-white px-4 py-2 rounded-lg hover:opacity-80 text-sm">Hapus Rentang Waktu</button>
                </div>
                </div>
                ...
                <table class="w-full table-auto border-collapse border border-gray-300 text-sm text-center">
                    ...
                    <tr>
                        ...
                        <th class="px-4 py-2">Gas (PPM)</th>
                        <th class="px-4 py-2">Status</th>
                    </tr>
                    </thead>
                    <tbody id="historyTable" class="bg-orange-100 text-black opacity-70">
                ...
                <!-- Optional Modal -->
                <div class="hidden fixed inset-0 z-50 bg-black bg-opacity-40 justify-center items-center" id="userModal">
                <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                    <div class="flex justify-between items-center mb-4">
                    <h5 class="text-xl font-semibold">Add New User</h5>
                    <button type="button" class="text-red-500 text-2xl font-bold" onclick="hideModal()">&times;</button>
                    </div>
                    <form id="userForm">
                    <div class="mb-3">
                        <label for="userName" class="block text-sm font-medium">Name</label>
                        <input type="text" id="userName" class="w-full border rounded px-3 py-2 mt-1" required />
                    </div>
                    <div class="mb-3">
                        <label for="userEmail" class="block text-sm font-medium">Email</label>
                        <input type="email" id="userEmail" class="w-full border rounded px-3 py-2 mt-1" required />
                    </div>
                    <div class="mb-4">
                        <label for="userPassword" class="block text-sm font-medium">Password</label>
                        <input type="password" id="userPassword" class="w-full border rounded px-3 py-2 mt-1" required />
                    </div>
                    <div class="flex justify-end">
                        <button type="submit" class="bg-orange-500 text-white px-4 py-2 rounded hover:opacity-80">Save User</button>
                    </div>
                    </form>
                </div>
                </div>
