        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto bg-gradient-to-r from-red-800 via-orange-800 to-yellow-500 0">
            ...
            <main class="px-4 sm:px-6 lg:px-8 py-10">
                <div class="grid gap-8 rounded-3xl bg-white border-4 border-orange-700 p-6 sm:p-8 lg:p-10">
                    ...
                    <p class="font-light mt-2 text-sm sm:text-base">Set your threshold and notification the way you want!</p>
                    </div>

                    <!-- Card: Threshold Aktif -->
                    <div class="bg-white shadow-md rounded-xl p-4 sm:p-6">
                    <h1 class="text-xl sm:text-2xl font-semibold mb-4">Manajemen Threshold PPM</h1>

                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-4">
                        <h3 class="text-base sm:text-lg font-medium">Threshold Aktif:</h3>
                        <button class="text-sm rounded-3xl bg-orange-500 text-white px-4 py-2 hover:opacity-80" id="openModalBtn">Tambah Threshold</button>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        ...
                        <thead class="bg-orange-500 text-white">
                            <tr>
                            <th class="px-4 py-2">Nilai (PPM)</th>
                            <th class="px-4 py-2">Deskripsi</th>
                            <th class="px-4 py-2">Output</th>
                            <th class="px-4 py-2">Aksi</th>
                            </tr>
                        </thead>
                        <tbody id="thresholdTable" class="text-center"></tbody>
                        </table>
                    </div>
                    </div>

                    <!-- Modal -->
                    <div id="thresholdModal" class="modal fixed inset-0 bg-black bg-opacity-40 items-center justify-center z-50 hidden">
                    <div class="bg-white rounded-lg shadow-lg p-6 w-[90%] sm:w-96">
                        <h3 class="text-xl font-semibold mb-4">Tambah Threshold</h3>
                        <input type="number" id="modalValue" placeholder="Nilai threshold (PPM)" class="border rounded-lg px-3 py-2 w-full mb-3">
                        <textarea id="modalDescription" rows="3" placeholder="Deskripsi" class="border rounded-lg px-3 py-2 w-full mb-3"></textarea>

                        <label for="modalOutput" class="block mb-1 text-sm font-medium">Aksi jika terpicu:</label>
                        <select id="modalOutput" class="border rounded-lg px-3 py-2 w-full mb-4">
                        ...
                        <button id="saveThresholdBtn" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:opacity-80">Simpan</button>
                        <button onclick="closeModal()" class="bg-red-600 text-white px-4 py-2 rounded-lg hover:opacity-80">Batal</button>
                        </div>
                    </div>
                    </div>
